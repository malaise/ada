...
package Many_Strings is
  ...
  function Set (To : Asu_Us) return Many_String;
  procedure Set (Str : in out Many_String; To : in String);
  procedure Set (Str : in out Many_String; To : in Asu_Us);
  ...
  function Nth (Str : Many_String; N : Positive) return Asu_Us;
