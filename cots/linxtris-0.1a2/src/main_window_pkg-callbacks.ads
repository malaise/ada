...
package Main_Window_Pkg.Callbacks is
   ...
   procedure On_Item_Game_Quit_Pressed (Item: access Gtk_Menu_Item_Record'Class);
        ...
        procedure On_Item_Game_New_Pressed( Item: access Gtk_Menu_Item_Record'Class );

        procedure On_Item_Game_Pause_Pressed( Item: access Gtk_Menu_Item_Record'Class );

        procedure On_Item_Game_Scores_Pressed( Item: access Gtk_Menu_Item_Record'Class );

        procedure On_Item_Settings_Preferences_Pressed( Item: access Gtk_Menu_Item_Record'Class );

        procedure On_Item_Help_About_Pressed( Item: access Gtk_Menu_Item_Record'Class );
