...
package body Mcd_Parser is
  ...
  (Add      => ("+ ", "push B + A                                        ", As.U.Asu_Null, False),
   ...
   Degms    => (Nosy, "A.frac -> A.MinSecMillis                          ", As.U.Asu_Null, False),
   Degfr    => (Nosy, "A.MinSecMillis -> A.frac                          ", As.U.Asu_Null, False),
   ...
   Inkeytim => (Nosy, "push key pressed within timeout or false          ", As.U.Asu_Null, False),
   ...
   Clockof  => (Nosy, "YYyy-mm-ddThh:mm:ss.mmm -> int                    ", As.U.Asu_Null, False),
   Dateimg  => (Nosy, "int, string format -> string image                ", As.U.Asu_Null, True),
   -- Execution
