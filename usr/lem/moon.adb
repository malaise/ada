...
package body Moon is
  ...
  -- Init a new moon
  procedure Init is
    -- Index of the central point of the landing site (2 .. 50)
    subtype Landing_Range is Point_Range
            range Point_Range'First + 1 .. Point_Range'Last - 1;
