...
procedure T_Strnav is
  ...
  begin
    for I in -10 .. 10 loop
      Ada.Text_Io.Put_Line ("Lookup " & Normal (I, 3) & " -> " & N.Lookup (I));
    end loop;
  end Dump;

begin
  Ada.Text_Io.Put_Line ("Init navig to ""1234567890"", (starting at 8 from init string)");
  Nav.Set (Str (8 .. 17));
  ...
  Ada.Text_Io.Put_Line (Nav.Image);
