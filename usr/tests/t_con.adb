...
procedure T_Con is
  ...
  begin
    ...
    Con_Io.Set_Foreground (Con_Io.Light_Blue, Con_Io.Not_Blink, W1);
    Con_Io.Set_Foreground (Con_Io.Cyan, Con_Io.Not_Blink, W2);
    Con_Io.Set_Foreground (Con_Io.Light_Green, Con_Io.Not_Blink, W3);

    Con_Io.Set_Background (Con_Io.Blue, W1);
    Con_Io.Set_Background (Con_Io.Red, W2);
    Con_Io.Set_Background (Con_Io.Green, W3);

    Redraw;

    Con_Io.Move (1, Col, W1);
    Con_Io.Get (Str(1..Width), Last, Stat, Pos, Ins,
       W1, Con_Io.Current, Con_Io.Current, Con_Io.Red, Delt);
    loop
        Con_Io.Clear (W2);
