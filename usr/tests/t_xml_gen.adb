...
begin
  ...
  Dscr.Add_Brother ("Var", Xml_Generator.Element);
  Dscr.Add_Attribute ("Name", "V1");
  Dscr.Add_Attribute ("Type", "Int");
  Dscr.Add_Child ("5", Xml_Generator.Text);
  Dscr.Move_Father;

  Dscr.Add_Brother ("Var", Xml_Generator.Element);
  Dscr.Add_Attribute ("Name", "PATH");
  Dscr.Add_Attribute ("Type", "Str");
  Dscr.Add_Child ("${PATH}:/usr/local/bin", Xml_Generator.Text);
  Dscr.Move_Father;

  Dscr.Add_Brother ("Var", Xml_Generator.Element);
  Dscr.Add_Attribute ("Name", "V2");
  Dscr.Add_Attribute ("Type", "Int");
  Dscr.Add_Child ("5*${V1}*${V1}", Xml_Generator.Text);
  Dscr.Move_Father;

  Dscr.Add_Brother ("Var", Xml_Generator.Element);
  Dscr.Add_Attribute ("Name", "V3");
  Dscr.Add_Attribute ("Type", "Str");
  Dscr.Add_Child ("${V1}*${V2}", Xml_Generator.Text);
  Dscr.Move_Father;

  Dscr.Add_Brother ("Var", Xml_Generator.Element);
  Dscr.Add_Attribute ("Name", "V2");
  Dscr.Add_Attribute ("Type", "Int");
  Dscr.Add_Child ("${V3}*2", Xml_Generator.Text);
  Dscr.Move_Father;

  Dscr.Add_Brother (
   " Comp_var will report error if variable SET_ME is not set ",
   Xml_Generator.Comment);
