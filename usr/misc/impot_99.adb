...
begin
  ...
  declare
    ...
    -- les plafonds
    -- deduction 10%
    Plafond_1_H : constant Somme := 077_850.00;
    -- abattement 20%
    Plafond_2_H : constant Somme := 142_200.00;
  begin
    -- le salaire net imposable
  ...
  declare
    ...
    Les_Tranches_Familiales : constant Liste_Tranches_Familiales := (
      1=> ( Somme_Max=>026_230.0, Coefficient=>000, Fixe=>00_000.00),
      2=> ( Somme_Max=>051_600.0, Coefficient=>105, Fixe=>02_740.15),
      3=> ( Somme_Max=>090_820.0, Coefficient=>240, Fixe=>09_670.15),
      4=> ( Somme_Max=>147_050.0, Coefficient=>330, Fixe=>17_893.95),
      5=> ( Somme_Max=>239_270.0, Coefficient=>430, Fixe=>32_598.95),
      6=> ( Somme_Max=>295_070.0, Coefficient=>480, Fixe=>44_562.45),
      7=> ( Somme_Max=>Somme'Last,Coefficient=>540, Fixe=>62_266.65));
  begin
  ...
  begin
    ...
    -- Plafond des dons ig : 6% du revenu net imposable
    Plafond := 6.0 * Revenu_Net_Imposable;
    if Dons > Plafond then
      Dons := Plafond;
    end if;
    -- Deduction : 50% des ig
    Resultat := Resultat - 0.5 * Dons;
