...
begin
  ...
  declare
    ...
    -- les plafonds
    -- deduction 10%
    Plafond_1_H : constant Somme := 078_950.00;
    -- abattement 20%
    Plafond_2_H : constant Somme := 144_400.00;
  begin
    -- le salaire net imposable
  ...
  declare
    ...
    Les_Tranches_Familiales : constant Liste_Tranches_Familiales := (
      1=> ( Somme_Max=>026_600.0, Coefficient=>0000, Fixe=>00_000.00),
      2=> ( Somme_Max=>052_320.0, Coefficient=>0825, Fixe=>02_194.50),
      3=> ( Somme_Max=>092_090.0, Coefficient=>2175, Fixe=>09_257.70),
  ...
  declare
    Dons : Somme;
    -- Plafond des dons : 6% du revenu net imposable
    Plafond : constant Somme := 6.0 * Revenu_Net_Imposable;
